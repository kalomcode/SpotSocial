...
function deletePublication(req, res) {
    ...
    Publication.findOneAndDelete({
        ...
        return res.status(200).send({
            message: 'Publicacion borrada correctamente'
        });
    })
...
// Subir archivos en las publicaciones
function uploadImage(req, res) {
    ...
    if (req.files) {
        ...
        if (file_ext == 'png' || file_ext == 'jpg' || file_ext == 'PNG' || file_ext == 'JPG' || file_ext == 'jpeg' || file_ext == 'gif') {
